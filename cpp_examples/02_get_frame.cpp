/**
 * Пример использования библиотеки технического зрения.
 * Считывает изображение с камеры и сохраняет как img.png
 */
...
int main() {
    ...
    // Устанавливаем ширину кадров, которые будем считывать с веб-камеры
